...
<div class="row">
         ...
         <div class="card wow fadeInLeft" style="width: 18rem;">
          <a href="haircut.php"> <img src="img/services/hc.jpg" alt="" class="card-img-top"></a>  
          <div class="card-body">
        ...
        <div class="col-lg-3">
         <div class="card wow fadeInLeft" style="width: 18rem;">
           <a href="haircolor.php"><img src="img/services/hclr.jpg" alt="" class="card-img-top"></a>  
          <div class="card-body">
        ...
        <div class="col-lg-3">
         <div class="card wow fadeInLeft" style="width: 18rem;">
            <a href="haircare.php"><img src="img/services/hcr.jpg" alt="" class="card-img-top"></a>  
          <div class="card-body">
         ...
         <div class="col-lg-3">
         <div class="card wow fadeInLeft" style="width: 18rem;">
            <a href="hairtreat.php"><img src="img/services/ht.jpg" alt="" class="card-img-top"></a>  
          <div class="card-body">
